...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("TodoApp") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "TodoApp", DisplayName = "TodoApp API", Resources = { "TodoApp" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["TodoApp_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["TodoApp_App:RootUrl"]?.TrimEnd('/');
        ...
        {
            var swaggerRootUrl = configurationSection["TodoApp_Swagger:RootUrl"]?.TrimEnd('/');
